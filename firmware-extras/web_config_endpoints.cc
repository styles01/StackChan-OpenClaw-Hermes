...
static esp_err_t config_html_handler(httpd_req_t* req) {
    ...
    httpd_resp_sendstr(req,
        ...
        "<label>Agent ID</label><input id='oc_agent_id' value='your-agent'>"
        "<label>Default Model</label><input id='oc_default_model' value='openclaw/your-agent'>"
        "<h2>Hermes</h2>"
        ...
        "<label>Default Model</label><input id='hm_default_model' value='hermes/your-agent'>"
        ...
        "document.getElementById('oc_agent_id').value=d.openclaw.agent_id||'your-agent';"
        "document.getElementById('oc_default_model').value=d.openclaw.default_model||'openclaw/your-agent';"
        ...
        "document.getElementById('hm_default_model').value=d.hermes.default_model||'hermes/your-agent';}"
        "async function save(){"
